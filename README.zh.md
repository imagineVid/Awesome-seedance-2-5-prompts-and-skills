...
| 已核验案例 | **11** |
| 编辑精选 | **2** |
| 生成时间 | **2026年8月3日星期一 UTC 14:48:18** |
...
来自 X 的精选提示词案例，保留清晰视觉目标、可控构图、公开素材证据与来源可追溯性。

##### 本地化提示词

```
本地化版本：保留以下英文源提示词的镜头、构图、主体一致性和负面约束；如需出现文字或对白，请替换为本语言。
...
<sub>根据版本化本地数据生成于 2026-08-03T14:48:18.009Z</sub>
