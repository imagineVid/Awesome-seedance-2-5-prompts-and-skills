...
> 面向 Seedance 2.5、可核验来源的镜头简报、运动模式与视听工作流库。
# Awesome Seedance 2.5 提示词与技能
...
**[在 ImagineVid 中打开 Seedance 2.5 工作流](https://imaginevid.io/seedance-2-0)**

本仓库以可核查证据为基础，而不是追逐发布热度。在 ImagineVid 推出独立的 Seedance 2.5 页面前，当前链接会打开已有的 Seedance 2.0 工作流。

发布消息不等于模型证据。只有当来源明确标注 Seedance 2.5，并提供足够完整的提示词与视频素材，能够讲清可复用方法时，案例才会被收录。
...
- [**多模态参考素材导演**](#workflow-multimodal-reference-direction) - 为每份参考素材指定职责 - 明确哪项输入负责身份、构图、运动、声音或视觉处理
- [**长镜头调度与镜头路径**](#workflow-long-take-blocking-camera-paths) - 围绕构图、镜头路径、调度、节奏、揭示和转场构建的镜头简报。
- [**对白、拟音与音乐时序**](#workflow-dialogue-foley-music-timing) - 以对白、表演、环境声、音乐或同步声音推动场景的表演型提示词。
- [**叙事连续性与角色表演**](#workflow-narrative-continuity-character-performance) - 把连续性写成硬约束 - 在整段序列中保护身份、服装、产品几何、空间布局和光线
- [**产品、时尚与营销动态**](#workflow-product-fashion-campaign-motion) - 让产品、优惠、服装、菜肴、设备或品牌时刻成为运动中心的商业片段。
- [**视频编辑、延展与风格重塑**](#workflow-video-editing-extension-restyling) - 重塑、延展、添加、移除、替换或改导现有视频场景，同时保护连续性的工作流。

---

## 目录

- [使用 Seedance 2.5 创作](#使用-seedance-25-创作)
...
**Seedance 2.5** 是 2026 年 7 月相关报道中披露的下一代 Seedance 视频模型名称。目前，ByteDance Seed 公开模型目录尚未提供完整的 Seedance 2.5 模型卡、稳定 API 标识或详细公开规格。因此，本仓库会严格区分已确认的一手资料与社区说法，并在 ByteDance 发布稳定文档后及时调整收录范围。

提示词库只关注可从真实结果中检验的内容：参考素材的用途、可见动作、镜头路径、节拍时序、对白与声音提示、连续性约束和剪辑意图。任何数字化能力声明，在获得稳定的一手来源前都不会纳入。

- **为每份参考素材指定职责** - 明确哪项输入负责身份、构图、运动、声音或视觉处理
- **描述可见的因果关系** - 将每个动作与观众应看到的运动、反应或环境变化对应起来
- **按节拍拆解场景** - 用可观察的连续时刻推进，而不是笼统概括剧情
- **导演声音轨道** - 只在对白、拟音、环境声或音乐确实推动场景时写入对应提示
- **说清镜头路径** - 定义景别、运动方式、主体距离以及关键镜头之间的过渡
- **把连续性写成硬约束** - 在整段序列中保护身份、服装、产品几何、空间布局和光线

**当前参考：** [Seedance 2.5 release reporting](https://www.theinformation.com/briefings/bytedance-unveils-seedance-2-5-video-model) · [ByteDance Seed model catalog](https://seed.bytedance.com/en/models) · [Available Seedance workflow on ImagineVid](https://imaginevid.io/seedance-2-0)
...
| 已核验案例 | **12** |
| 编辑精选 | **2** |
| 生成时间 | **2026年8月13日星期四 UTC 05:43:16** |
...
一份紧凑的文生视频简报，在自然光和日常街区环境中保持骑行者清晰，并用平滑跟拍维持画面可读性。

#### 本地化提示词

```
本地化版本：保留以下英文源提示词的镜头、时间、主体一致性和负面约束；如需出现文字或对白，请替换为本语言。
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2074956835250122752/pu/img/fiGWvsKanTErJ-Ht.jpg" height="420" alt="金色时刻骑行穿过安静街区 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26)**
</div>

#### 证据

- **创作者:** [@noorwithwifi](https://x.com/noorwithwifi)
- **规范来源:** [规范来源](https://x.com/noorwithwifi/status/2074956913075491029)
- **发布时间:** 2026年7月8日
- **提示词语言:** en
...
一份高密度动作简报，以两名角色为参考，在十四秒时间轴内协调调度、镜头变化、慢动作、冲击特效和环境反馈。
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28"><img src="https://pbs.twimg.com/amplify_video_thumb/2077336525373923328/img/X_8KtfVsQRT45Kfa.jpg" height="420" alt="双参考图工业格斗与分秒冲击设计 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28)**
</div>

#### 证据

- **创作者:** [@AIReelofficial](https://x.com/AIReelofficial)
- **规范来源:** [规范来源](https://x.com/AIReelofficial/status/2077729460644872389)
- **发布时间:** 2026年7月16日
- **提示词语言:** en
...
- [双参考图工业格斗与分秒冲击设计](#prompt-3)

<a id="prompt-7"></a>

#### #1: 新增案例：A seamless sequence on a vast frozen mountain peak

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### 工作流为何重要

来自 X 的可复用提示词案例，重点保留清晰的视觉目标、可控构图和来源可追溯性。
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2081585276347121664/vid/avc1/1920x1080/mTsw-MR6gwrWSBUY.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2081585276347121664/img/T7nboWV2ufp0gfxn.jpg" height="420" alt="新增案例：A seamless sequence on a vast frozen mountain peak - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2081585276347121664/vid/avc1/1920x1080/mTsw-MR6gwrWSBUY.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [Zephyra Leigh](https://x.com/ZephyraLeigh)
- **规范来源:** [规范来源](https://x.com/ZephyraLeigh/status/2081585413475766574)
- **发布时间:** 2026年7月27日
- **提示词语言:** en
...
一条刻意保持简短的提示词，用来观察单一主体、工作台环境和持续动作如何扩展成长镜头。
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2077113718106648577/pu/img/EyN9swzCeqGu4nZy.jpg" height="420" alt="赛博朋克黑客机器人三十秒一镜到底 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12)**
</div>
...
#### #5: 新增案例：Early morning; sunlight filters through the forest canopy, casting
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2079123345271136256/vid/avc1/1920x1080/stv5h4mJLVg6P1i_.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2079123345271136256/img/ZS0OHkasBrQH4Gbs.jpg" height="420" alt="新增案例：Early morning; sunlight filters through the forest canopy, casting - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2079123345271136256/vid/avc1/1920x1080/stv5h4mJLVg6P1i_.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [AIReel](https://x.com/AIReelofficial)
- **规范来源:** [规范来源](https://x.com/AIReelofficial/status/2079531584869548309)
- **发布时间:** 2026年7月21日
- **提示词语言:** en
...
包含明确时间节点、空中到地面的镜头编排、真实积雪互动和原生环境音的来源明确 Seedance 2.5 长镜头简报。

##### 本地化提示词

```
本地化版本：保留英文标准提示词中的镜头、时间、车辆连续性和约束，只调整画面文字或对白。
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358073772945408/img/QdQ4DkwTFlI-e-Tc.jpg" width="100%" alt="连续追车镜头中的雪崩逃生 - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358249719844864/img/Eefi6d1zUqPCw5KH.jpg" width="100%" alt="连续追车镜头中的雪崩逃生 - Image 2"></td>
</tr>
</table>
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2080358249719844864/vid/avc1/1280x720/1s22T4RgtkM-uRH-.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358249719844864/img/Eefi6d1zUqPCw5KH.jpg" height="420" alt="连续追车镜头中的雪崩逃生 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2080358249719844864/vid/avc1/1280x720/1s22T4RgtkM-uRH-.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [Brent Lynch](https://x.com/BrentLynch)
- **规范来源:** [规范来源](https://x.com/BrentLynch/status/2080359232160120942)
- **发布时间:** 2026年7月23日
- **提示词语言:** en
...
#### #8: 带触感 ASMR 节奏的压花 vlog

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### 工作流为何重要

从准备、触感压花、自然对话、书本重量、卡片排列到摄像机真实感的来源明确 Seedance 2.5 UGC 简报。
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084268630556983296/vid/avc1/1920x1080/kPWIx5WQsdO1yzGR.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084268630556983296/img/OXmdFhcGjZVL1k5f.jpg" height="420" alt="带触感 ASMR 节奏的压花 vlog - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2084268630556983296/vid/avc1/1920x1080/kPWIx5WQsdO1yzGR.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [𝐌](https://x.com/Strength04_X)
- **规范来源:** [规范来源](https://x.com/Strength04_X/status/2084269139556761919)
- **发布时间:** 2026年8月3日
- **提示词语言:** en
...
以可复用指令和可核验结果媒体测试“夏威夷热带旅行日记”的来源明确案例。
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084238008266493952/img/hmRCH9_UZ7aXhaeO.jpg" height="420" alt="夏威夷热带旅行日记 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [Sharon Riley](https://x.com/Just_sharon7)
- **规范来源:** [规范来源](https://x.com/Just_sharon7/status/2084238339469615320)
- **发布时间:** 2026年8月3日
- **提示词语言:** en
...
1. [**提交视频提示词**](https://github.com/imagineVid/Awesome-seedance-2-5-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. 提供完整简报、来源、创作者、模型证据和可播放媒体
3. 维护者会检查出处、视频价值、范围和重复项
4. 获批案例会标准化到本地数据源
5. 通过全部质量检查后，生成器会发布该案例

**编辑规则：** 发布消息不等于模型证据。只有当来源明确标注 Seedance 2.5，并提供足够完整的提示词与视频素材，能够讲清可复用方法时，案例才会被收录。
...
**[仓库增长](https://star-history.com/#imagineVid/Awesome-seedance-2-5-prompts-and-skills&Date)**

---

<div align="center">

**[使用 Seedance 2.5 创作](https://imaginevid.io/seedance-2-0)** •
...
<sub>根据版本化本地数据生成于 2026-08-13T05:43:16.718Z</sub>
