...
const WORKFLOW_BY_TITLE: Record<string, { id: number; title: string; slug: string }> = {
  "Multimodal Reference Direction": { id: 71, title: "Multimodal Reference Direction", slug: "multimodal-reference-direction" },
  "Long-Take Blocking & Camera Paths": { id: 72, title: "Long-Take Blocking & Camera Paths", slug: "long-take-blocking-camera-paths" },
  "Dialogue, Foley & Music Timing": { id: 73, title: "Dialogue, Foley & Music Timing", slug: "dialogue-foley-music-timing" },
  "Narrative Continuity & Character Performance": { id: 74, title: "Narrative Continuity & Character Performance", slug: "narrative-continuity-character-performance" },
  "Product, Fashion & Campaign Motion": { id: 75, title: "Product, Fashion & Campaign Motion", slug: "product-fashion-campaign-motion" },
  "Video Editing, Extension & Restyling": { id: 76, title: "Video Editing, Extension & Restyling", slug: "video-editing-extension-restyling" },
};
...
async function main() {
  ...
  if (modelVersion !== "seedance-2.5") {
    throw new Error("Approved issue must contain explicit Seedance 2.5 model evidence");
  }
