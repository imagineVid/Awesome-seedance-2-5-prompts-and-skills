...
> Seedance 2.5를 위한 출처 검증형 샷 브리프, 모션 패턴, 시청각 워크플로 라이브러리입니다.
# Awesome Seedance 2.5 프롬프트 및 스킬
...
**[ImagineVid에서 Seedance 2.5 워크플로 열기](https://imaginevid.io/seedance-2-0)**

이 저장소는 출시 홍보가 아니라 검증 가능한 근거를 중심으로 구축됩니다. Seedance 2.5 전용 경로가 생기기 전까지 연결된 ImagineVid 페이지는 현재 제공되는 Seedance 2.0 워크플로를 엽니다.

출시 주장은 모델 증거가 아닙니다. 출처가 Seedance 2.5를 명시하고 재현 가능한 제작 방식을 배울 만큼 충분한 프롬프트와 영상을 제공할 때만 사례를 수록합니다.
...
- [**멀티모달 참조 연출**](#workflow-multimodal-reference-direction) - 각 참조 자료에 역할 지정 - 어떤 입력이 정체성, 구도, 움직임, 사운드 또는 시각 처리를 제어하는지 명시합니다
- [**롱테이크 블로킹 및 카메라 경로**](#workflow-long-take-blocking-camera-paths) - 프레이밍, 카메라 경로, 블로킹, 페이싱, 공개 순서, 전환을 중심으로 구성한 샷 브리프입니다.
- [**대사, 폴리 및 음악 타이밍**](#workflow-dialogue-foley-music-timing) - 대사, 연기, 분위기음, 음악 또는 동기화된 사운드가 장면을 이끄는 퍼포먼스 중심 프롬프트입니다.
- [**내러티브 연속성 및 캐릭터 연기**](#workflow-narrative-continuity-character-performance) - 연속성을 제약으로 작성 - 시퀀스 전반에서 인물, 의상, 제품 형태, 공간 배치와 조명을 보호합니다
- [**제품, 패션 및 캠페인 모션**](#workflow-product-fashion-campaign-motion) - 제품, 오퍼, 의상, 요리, 기기 또는 브랜드 순간을 움직임의 중심에 두는 광고 클립입니다.
- [**비디오 편집, 확장 및 스타일 변경**](#workflow-video-editing-extension-restyling) - 연속성을 보호하면서 기존 영상의 스타일을 바꾸고 확장, 추가, 제거, 교체하거나 장면의 방향을 바꾸는 워크플로입니다.

---

## 목차

- [Seedance 2.5로 만들기](#seedance-25로-만들기)
- [Seedance 2.5란?](#seedance-25란)
- [컬렉션 상태](#컬렉션-상태)
...
**Seedance 2.5**는 2026년 7월 보도를 통해 알려진 차세대 Seedance 비디오 모델의 명칭입니다. ByteDance의 공개 Seed 모델 카탈로그에는 아직 완전한 Seedance 2.5 모델 카드, 안정적인 API 식별자 또는 상세 공개 사양이 없습니다. 따라서 이 저장소는 확인된 1차 자료와 커뮤니티 주장을 구분하며, ByteDance가 지속적으로 참조 가능한 문서를 공개하면 범위를 갱신합니다.
...
- **각 참조 자료에 역할 지정** - 어떤 입력이 정체성, 구도, 움직임, 사운드 또는 시각 처리를 제어하는지 명시합니다
- **보이는 원인과 결과 설명** - 각 행동을 화면에 나타날 움직임, 반응 또는 환경 변화와 연결합니다
- **장면을 비트로 구성** - 줄거리 요약 대신 관찰 가능한 순간을 순서대로 나눕니다
- **사운드트랙 연출** - 장면을 진행시키는 지점에만 대사, 폴리, 환경음과 음악을 지정합니다
- **카메라 경로 명시** - 프레이밍, 이동, 피사체 거리와 주요 샷 사이의 전환을 정의합니다
- **연속성을 제약으로 작성** - 시퀀스 전반에서 인물, 의상, 제품 형태, 공간 배치와 조명을 보호합니다

**현재 참고 자료:** [Seedance 2.5 release reporting](https://www.theinformation.com/briefings/bytedance-unveils-seedance-2-5-video-model) · [ByteDance Seed model catalog](https://seed.bytedance.com/en/models) · [Available Seedance workflow on ImagineVid](https://imaginevid.io/seedance-2-0)
...
| 검증된 사례 | **12** |
| 에디터 추천 | **2** |
| 생성 시각 | **2026년 8월 21일 금요일 오후 12시 55분 26초 UTC** |
...
자연광이 비치는 일상적인 동네에서 한 명의 라이더와 부드러운 추적 카메라를 명확하게 유지하는 간결한 샷 브리프입니다.
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2074956835250122752/pu/img/fiGWvsKanTErJ-Ht.jpg" height="420" alt="조용한 도심을 달리는 골든아워 자전거 장면 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26)**
</div>

#### 근거

- **제작자:** [@noorwithwifi](https://x.com/noorwithwifi)
- **정식 출처:** [정식 출처](https://x.com/noorwithwifi/status/2074956913075491029)
- **게시일:** 2026년 7월 8일
- **프롬프트 언어:** en
...
두 전투원을 지정하고 블로킹, 카메라 전환, 슬로모션, 충격 효과와 환경 반응을 14초 동안 조율하는 밀도 높은 액션 브리프입니다.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28"><img src="https://pbs.twimg.com/amplify_video_thumb/2077336525373923328/img/X_8KtfVsQRT45Kfa.jpg" height="420" alt="두 참조 이미지로 만든 타임코드 산업 격투 장면 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28)**
</div>

#### 근거

- **제작자:** [@AIReelofficial](https://x.com/AIReelofficial)
- **정식 출처:** [정식 출처](https://x.com/AIReelofficial/status/2077729460644872389)
- **게시일:** 2026년 7월 16일
- **프롬프트 언어:** en
...
- [두 참조 이미지로 만든 타임코드 산업 격투 장면](#prompt-3)

<a id="prompt-7"></a>

#### #1: 신규 사례: A seamless sequence on a vast frozen mountain peak
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2081585276347121664/vid/avc1/1920x1080/mTsw-MR6gwrWSBUY.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2081585276347121664/img/T7nboWV2ufp0gfxn.jpg" height="420" alt="신규 사례: A seamless sequence on a vast frozen mountain peak - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2081585276347121664/vid/avc1/1920x1080/mTsw-MR6gwrWSBUY.mp4?tag=29)**
</div>

##### 근거

- **제작자:** [Zephyra Leigh](https://x.com/ZephyraLeigh)
- **정식 출처:** [정식 출처](https://x.com/ZephyraLeigh/status/2081585413475766574)
- **게시일:** 2026년 7월 27일
- **프롬프트 언어:** en
...
#### #2: 사이버펑크 해커 로봇의 30초 원테이크

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### 이 워크플로가 중요한 이유

하나의 피사체, 작업 공간과 지속 동작이 긴 장면으로 어떻게 확장되는지 살펴볼 수 있는 의도적으로 간결한 프롬프트입니다.
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2077113718106648577/pu/img/EyN9swzCeqGu4nZy.jpg" height="420" alt="사이버펑크 해커 로봇의 30초 원테이크 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12)**
</div>
...
#### #5: 신규 사례: Early morning; sunlight filters through the forest canopy, casting
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2079123345271136256/vid/avc1/1920x1080/stv5h4mJLVg6P1i_.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2079123345271136256/img/ZS0OHkasBrQH4Gbs.jpg" height="420" alt="신규 사례: Early morning; sunlight filters through the forest canopy, casting - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2079123345271136256/vid/avc1/1920x1080/stv5h4mJLVg6P1i_.mp4?tag=29)**
</div>

##### 근거

- **제작자:** [AIReel](https://x.com/AIReelofficial)
- **정식 출처:** [정식 출처](https://x.com/AIReelofficial/status/2079531584869548309)
- **게시일:** 2026년 7월 21일
- **프롬프트 언어:** en
...
- **제작자:** [Brent Lynch](https://x.com/BrentLynch)
- **정식 출처:** [정식 출처](https://x.com/BrentLynch/status/2080359232160120942)
- **게시일:** 2026년 7월 23일
- **프롬프트 언어:** en
...
- [조용한 도심을 달리는 골든아워 자전거 장면](#prompt-1)
...
검증 가능한 결과 미디어와 재사용 가능한 지침으로 '하와이 열대 여행 다이어리'을 테스트하는 출처 기반 사례입니다.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084238008266493952/img/hmRCH9_UZ7aXhaeO.jpg" height="420" alt="하와이 열대 여행 다이어리 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29)**
</div>

##### 근거

- **제작자:** [Sharon Riley](https://x.com/Just_sharon7)
- **정식 출처:** [정식 출처](https://x.com/Just_sharon7/status/2084238339469615320)
- **게시일:** 2026년 8월 3일
- **프롬프트 언어:** en
...
1. [**비디오 프롬프트 제출**](https://github.com/imagineVid/Awesome-seedance-2-5-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**편집 원칙:** 출시 주장은 모델 증거가 아닙니다. 출처가 Seedance 2.5를 명시하고 재현 가능한 제작 방식을 배울 만큼 충분한 프롬프트와 영상을 제공할 때만 사례를 수록합니다.
...
**[저장소 성장](https://star-history.com/#imagineVid/Awesome-seedance-2-5-prompts-and-skills&Date)**

---

<div align="center">

**[Seedance 2.5로 만들기](https://imaginevid.io/seedance-2-0)** •
...
<sub>버전 관리된 로컬 데이터에서 생성된 시각 2026-08-21T12:55:26.337Z</sub>
