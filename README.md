...
> A source-checked field guide to Seedance 2.5 prompts, reference direction, and audiovisual production workflows.
...
> Read the prompt beside the result, verify where it came from, and reuse the production logic instead of imitating a finished clip.

> **Attribution and corrections:** Every published case retains its creator and canonical source. Rights remain with their owners. Open an issue for corrections or removal.
...
## Explore Seedance workflows

**[Open Seedance on ImagineVid](https://imaginevid.io/seedance-2-0)**

This repository is being built around evidence, not launch hype. The linked ImagineVid page currently opens the available Seedance 2.0 workflow until a dedicated Seedance 2.5 product route exists.
...
| Generation | - | Open Seedance |
| Reading | GitHub-native Markdown | Browser production workspace |
| Seedance workflows | - | Production filters |


### Browse by Seedance Workflow

- [**Multimodal Reference Direction**](#workflow-multimodal-reference-direction) - Assign a job to every reference - State which input controls identity, composition, movement, sound, or visual treatment
- [**Long-Take Blocking & Camera Paths**](#workflow-long-take-blocking-camera-paths) - Shot briefs built around framing, camera path, blocking, pacing, reveals, and transitions.
- [**Dialogue, Foley & Music Timing**](#workflow-dialogue-foley-music-timing) - Performance-led prompts where speech, acting, ambience, music, or synchronized sound carries the scene.
- [**Narrative Continuity & Character Performance**](#workflow-narrative-continuity-character-performance) - Write continuity as a constraint - Protect identity, wardrobe, product geometry, spatial layout, and lighting across the sequence
- [**Product, Fashion & Campaign Motion**](#workflow-product-fashion-campaign-motion) - Commercial clips that keep a product, offer, garment, dish, device, or brand moment at the center of the motion.
- [**Video Editing, Extension & Restyling**](#workflow-video-editing-extension-restyling) - Existing-video workflows that restyle, extend, add, remove, replace, or redirect part of a scene while protecting continuity.

---

## Contents

- [Explore Seedance workflows](#explore-seedance-workflows)
...
- **Describe visible cause and effect** - Connect each action to the motion, reaction, or environmental change the viewer should see
- **Block the scene in beats** - Break a sequence into observable moments instead of summarizing the story
- **Direct the sound track** - Specify dialogue, Foley, ambience, and music only where each cue advances the scene
- **Name the camera path** - Define framing, movement, subject distance, and the transition between important shots
...
**Status references:** [Seedance 2.5 release reporting](https://www.theinformation.com/briefings/bytedance-unveils-seedance-2-5-video-model) · [ByteDance Seed model catalog](https://seed.bytedance.com/en/models) · [Available Seedance workflow on ImagineVid](https://imaginevid.io/seedance-2-0)

### Turn a Prompt into a Production Template

A reusable Seedance prompt keeps scene variables separate from direction. Replace the subject, location, spoken line, or product while retaining the camera path, beat structure, sound cues, reference roles, and continuity rules that made the test informative.

**Template pattern:**
```
[FORMAT]. References: [ASSET -> PURPOSE]. Scene: [SUBJECT + ACTION + SETTING]. Camera: [FRAMING + PATH]. Beats: [ORDERED EVENTS]. Audio: [DIALOGUE + FOLEY + AMBIENCE]. Preserve: [IDENTITY / OBJECT / SPACE]. Avoid: [VISIBLE FAILURE MODES].
```

Start with one visible action and one camera decision. Add references, sound, timing, and preservation constraints only when they solve a concrete production problem, then change one variable per test.
...
| Verified Cases | **12** |
| Editorial pick | **2** |
| Generated | **Wednesday, September 23, 2026 at 10:49:49 PM UTC** |
...
> Selected for reproducibility, evidence quality, and production usefulness

<a id="prompt-1"></a>

### #1: Golden-hour bicycle ride through quiet city streets
...
A compact text-to-video brief that keeps one rider and a gentle tracking move readable through natural daylight and an everyday neighborhood setting.
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2074956835250122752/pu/img/fiGWvsKanTErJ-Ht.jpg" height="420" alt="Golden-hour bicycle ride through quiet city streets - Motion preview"></a>

*Click the preview to open the video* · **[▶ Watch video →](https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26)**
</div>

#### Evidence

- **Creator:** [@noorwithwifi](https://x.com/noorwithwifi)
- **Canonical source:** [Canonical source](https://x.com/noorwithwifi/status/2074956913075491029)
...
### #2: Two-reference industrial fight with timestamped impacts
...
A dense image-referenced action brief that assigns two fighters, then coordinates blocking, camera changes, slow motion, impact effects, and environmental reactions across a fourteen-second timeline.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28"><img src="https://pbs.twimg.com/amplify_video_thumb/2077336525373923328/img/X_8KtfVsQRT45Kfa.jpg" height="420" alt="Two-reference industrial fight with timestamped impacts - Motion preview"></a>

*Click the preview to open the video* · **[▶ Watch video →](https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28)**
</div>

#### Evidence

- **Creator:** [@AIReelofficial](https://x.com/AIReelofficial)
- **Canonical source:** [Canonical source](https://x.com/AIReelofficial/status/2077729460644872389)
...
A deliberately minimal prompt paired with a thirty-second result, useful for studying how a single subject, workstation setting, and sustained action expand into a long take.
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2077113718106648577/pu/img/EyN9swzCeqGu4nZy.jpg" height="420" alt="Thirty-second cyberpunk hacker robot one-take - Motion preview"></a>

*Click the preview to open the video* · **[▶ Watch video →](https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12)**
</div>
...
#### #6: Avalanche escape in a single continuous chase

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Why the workflow matters

A source-backed Seedance 2.5 long-take brief with explicit timing, aerial-to-ground camera choreography, physical snow interaction, and native environmental sound.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358073772945408/img/QdQ4DkwTFlI-e-Tc.jpg" width="100%" alt="Avalanche escape in a single continuous chase - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358249719844864/img/Eefi6d1zUqPCw5KH.jpg" width="100%" alt="Avalanche escape in a single continuous chase - Image 2"></td>
</tr>
</table>
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2080358249719844864/vid/avc1/1280x720/1s22T4RgtkM-uRH-.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358249719844864/img/Eefi6d1zUqPCw5KH.jpg" height="420" alt="Avalanche escape in a single continuous chase - Motion preview"></a>
...
#### #8: Flower-pressing vlog with tactile ASMR timing

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Why the workflow matters

A source-backed Seedance 2.5 UGC brief moving from setup to tactile flower pressing, natural dialogue, book weight, card arrangement, and camcorder realism.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084268630556983296/vid/avc1/1920x1080/kPWIx5WQsdO1yzGR.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084268630556983296/img/OXmdFhcGjZVL1k5f.jpg" height="420" alt="Flower-pressing vlog with tactile ASMR timing - Motion preview"></a>

*Click the preview to open the video* · **[▶ Watch video →](https://video.twimg.com/amplify_video/2084268630556983296/vid/avc1/1920x1080/kPWIx5WQsdO1yzGR.mp4?tag=29)**
</div>

##### Evidence

- **Creator:** [𝐌](https://x.com/Strength04_X)
- **Canonical source:** [Canonical source](https://x.com/Strength04_X/status/2084269139556761919)
...
- [Golden-hour bicycle ride through quiet city streets](#prompt-1)

<a id="prompt-10"></a>

#### #9: Hawaii tropical travel diary

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Why the workflow matters

A source-backed Seedance 2.5 travel diary that maintains one performer across eight connected Hawaii scenes, from city arrival to a quiet hotel-night close.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084238008266493952/img/hmRCH9_UZ7aXhaeO.jpg" height="420" alt="Hawaii tropical travel diary - Motion preview"></a>

*Click the preview to open the video* · **[▶ Watch video →](https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29)**
</div>

##### Evidence

- **Creator:** [Sharon Riley](https://x.com/Just_sharon7)
- **Canonical source:** [Canonical source](https://x.com/Just_sharon7/status/2084238339469615320)
- **Published:** August 3, 2026
- **Prompt language:** en
...
#### #10: Organic grocery UGC shopping vlog
...
1. [**Submit a video prompt**](https://github.com/imagineVid/Awesome-seedance-2-5-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. Provide the full brief, source, creator, model evidence, and playable media
3. A maintainer checks provenance, production value, scope, and duplicates
4. Approved cases are normalized into the local data source
5. The generator publishes the case after every quality check passes

**Editorial rule:** A launch claim is not model evidence. A case enters only when its source explicitly identifies Seedance 2.5 and exposes enough prompt and video material to teach something reproducible.
...
**[Repository Growth](https://star-history.com/#imagineVid/Awesome-seedance-2-5-prompts-and-skills&Date)**

---

<div align="center">

**[Explore Seedance workflows](https://imaginevid.io/seedance-2-0)** •
...
<sub>Generated from versioned local data on 2026-09-23T22:49:49.816Z</sub>
