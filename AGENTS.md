...
<directory>
data/ - English truth sources for categories, official cases, and eleven verified community prompts; reviewed prompt overlays cover all thirteen non-English views.
...
- The community set contains eleven independently screened X cases discovered through twitterapi.io; no inherited sibling-repository example or placeholder may enter it.
...
## Launch Boundary
- `data/prompts.json` contains eleven cases with explicit Seedance 2.5 evidence, complete public prompts, canonical attribution, and playable X video; `data/official-cases.json` stays empty until a first-party case meets the same reusable-evidence bar.
