...
> Проверяемая по источникам библиотека описаний кадров, паттернов движения и аудиовизуальных рабочих процессов для Seedance 2.5.
# Awesome Seedance 2.5: промпты и навыки
...
## Создавать с Seedance 2.5

**[Открыть рабочий процесс Seedance 2.5 в ImagineVid](https://imaginevid.io/seedance-2-0)**

Этот репозиторий строится на доказательствах, а не на ажиотаже вокруг запуска. Пока отдельной страницы Seedance 2.5 нет, ссылка ImagineVid открывает доступный рабочий процесс Seedance 2.0.

Сообщение о запуске не является доказательством модели. Кейс включается только тогда, когда источник прямо указывает Seedance 2.5 и содержит достаточно промпта и видео для воспроизводимого приёма.
...
| Генерация | - | Открыть Seedance 2.5 |
...
- [**Режиссура мультимодальных референсов**](#workflow-multimodal-reference-direction) - Назначьте роль каждому референсу - Укажите, какой вход управляет личностью, композицией, движением, звуком или визуальной обработкой
- [**Мизансцена и маршруты камеры в длинных планах**](#workflow-long-take-blocking-camera-paths) - Брифы кадров с композицией, маршрутом камеры, мизансценой, темпом, раскрытиями и переходами.
- [**Тайминг диалога, шумов и музыки**](#workflow-dialogue-foley-music-timing) - Промпты на основе исполнения, где речь, актёрская игра, атмосфера, музыка или синхронный звук несут сцену.
- [**Нарративная непрерывность и игра персонажей**](#workflow-narrative-continuity-character-performance) - Запишите непрерывность как ограничение - Сохраняйте личность, костюм, геометрию продукта, пространство и свет
- [**Движение продукта, моды и кампаний**](#workflow-product-fashion-campaign-motion) - Рекламные клипы, в которых продукт, предложение, одежда, блюдо, устройство или брендовый момент находятся в центре движения.
- [**Монтаж, продление и рестайлинг видео**](#workflow-video-editing-extension-restyling) - Работа с готовым видео: рестайлинг, продление, добавление, удаление, замена или перенаправление части сцены с сохранением непрерывности.

---

## Содержание

- [Создавать с Seedance 2.5](#создавать-с-seedance-25)
- [Что такое Seedance 2.5?](#что-такое-seedance-25)
...
- **Назначьте роль каждому референсу** - Укажите, какой вход управляет личностью, композицией, движением, звуком или визуальной обработкой
- **Опишите видимые причину и следствие** - Свяжите каждое действие с движением, реакцией или изменением среды в кадре
- **Разбейте сцену на биты** - Выстраивайте наблюдаемые моменты, а не пересказывайте сюжет
- **Режиссируйте звуковую дорожку** - Добавляйте диалог, шумы, атмосферу и музыку только там, где они развивают сцену
- **Назовите маршрут камеры** - Задайте кадрирование, движение, дистанцию до объекта и переходы между ключевыми планами
- **Запишите непрерывность как ограничение** - Сохраняйте личность, костюм, геометрию продукта, пространство и свет

**Актуальные ссылки:** [Seedance 2.5 release reporting](https://www.theinformation.com/briefings/bytedance-unveils-seedance-2-5-video-model) · [ByteDance Seed model catalog](https://seed.bytedance.com/en/models) · [Available Seedance workflow on ImagineVid](https://imaginevid.io/seedance-2-0)
...
| Сгенерировано | **понедельник, 14 сентября 2026 г. в 20:12:40 UTC** |
...
### #1: Велопрогулка в золотой час по тихим улицам
...
Компактный бриф сохраняет ясность героини и плавного сопровождения камеры в естественном свете обычного городского района.
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2074956835250122752/pu/img/fiGWvsKanTErJ-Ht.jpg" height="420" alt="Велопрогулка в золотой час по тихим улицам - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/ext_tw_video/2074956835250122752/pu/vid/avc1/1280x720/GGVJY84yqzPpP7dZ.mp4?tag=26)**
</div>

#### Доказательства

- **Автор:** [@noorwithwifi](https://x.com/noorwithwifi)
- **Канонический источник:** [Канонический источник](https://x.com/noorwithwifi/status/2074956913075491029)
...
### #2: Индустриальный бой с двумя референсами и точным таймингом
...
Плотный экшен-бриф координирует двух бойцов, мизансцену, смену камеры, замедление, удары и реакцию окружения в течение четырнадцати секунд.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28"><img src="https://pbs.twimg.com/amplify_video_thumb/2077336525373923328/img/X_8KtfVsQRT45Kfa.jpg" height="420" alt="Индустриальный бой с двумя референсами и точным таймингом - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2077336525373923328/vid/avc1/1920x1080/wlKvDYYr__Dylt21.mp4?tag=28)**
</div>

#### Доказательства

- **Автор:** [@AIReelofficial](https://x.com/AIReelofficial)
- **Канонический источник:** [Канонический источник](https://x.com/AIReelofficial/status/2077729460644872389)
...
### Режиссура мультимодальных референсов (2)

Назначьте роль каждому референсу - Укажите, какой вход управляет личностью, композицией, движением, звуком или визуальной обработкой

**Избранные видеопромпты**

- [Индустриальный бой с двумя референсами и точным таймингом](#prompt-3)

<a id="prompt-7"></a>

#### #1: Новый пример: A seamless sequence on a vast frozen mountain peak
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2081585276347121664/vid/avc1/1920x1080/mTsw-MR6gwrWSBUY.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2081585276347121664/img/T7nboWV2ufp0gfxn.jpg" height="420" alt="Новый пример: A seamless sequence on a vast frozen mountain peak - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2081585276347121664/vid/avc1/1920x1080/mTsw-MR6gwrWSBUY.mp4?tag=29)**
</div>

##### Доказательства

- **Автор:** [Zephyra Leigh](https://x.com/ZephyraLeigh)
- **Канонический источник:** [Канонический источник](https://x.com/ZephyraLeigh/status/2081585413475766574)
...
### Мизансцена и маршруты камеры в длинных планах (5)

Брифы кадров с композицией, маршрутом камеры, мизансценой, темпом, раскрытиями и переходами.

<a id="prompt-2"></a>

#### #2: Тридцатисекундный непрерывный план с киберпанк-роботом

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Зачем нужен этот рабочий процесс

Намеренно минимальный промпт для изучения того, как один герой, рабочее место и непрерывное действие раскрываются в длинном плане.
...
<div align="center">
<a href="https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12"><img src="https://pbs.twimg.com/ext_tw_video_thumb/2077113718106648577/pu/img/EyN9swzCeqGu4nZy.jpg" height="420" alt="Тридцатисекундный непрерывный план с киберпанк-роботом - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/ext_tw_video/2077113718106648577/pu/vid/avc1/1280x720/twNk6uhZZRnoFngO.mp4?tag=12)**
</div>
...
#### #3: Четыре сезона одним непрерывным планом
...
#### #4: Леопард замер в прыжке, пока камера движется
...
#### #5: Новый пример: Early morning; sunlight filters through the forest canopy, casting
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2079123345271136256/vid/avc1/1920x1080/stv5h4mJLVg6P1i_.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2079123345271136256/img/ZS0OHkasBrQH4Gbs.jpg" height="420" alt="Новый пример: Early morning; sunlight filters through the forest canopy, casting - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2079123345271136256/vid/avc1/1920x1080/stv5h4mJLVg6P1i_.mp4?tag=29)**
</div>

##### Доказательства

- **Автор:** [AIReel](https://x.com/AIReelofficial)
- **Канонический источник:** [Канонический источник](https://x.com/AIReelofficial/status/2079531584869548309)
...
#### #6: Побег от лавины в непрерывной погоне

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Зачем нужен этот рабочий процесс

Документированный бриф для длинного плана Seedance 2.5 с точным таймингом, хореографией камеры от воздуха к земле, физически правдоподобным снегом и нативным окружением.

##### Локализованный промпт

```
Локализованная версия: сохраняйте камеру, тайминг, непрерывность автомобиля и ограничения канонического английского промпта; меняйте только видимый текст или реплики.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358073772945408/img/QdQ4DkwTFlI-e-Tc.jpg" width="100%" alt="Побег от лавины в непрерывной погоне - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358249719844864/img/Eefi6d1zUqPCw5KH.jpg" width="100%" alt="Побег от лавины в непрерывной погоне - Image 2"></td>
</tr>
</table>
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2080358249719844864/vid/avc1/1280x720/1s22T4RgtkM-uRH-.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2080358249719844864/img/Eefi6d1zUqPCw5KH.jpg" height="420" alt="Побег от лавины в непрерывной погоне - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2080358249719844864/vid/avc1/1280x720/1s22T4RgtkM-uRH-.mp4?tag=29)**
</div>

##### Доказательства

- **Автор:** [Brent Lynch](https://x.com/BrentLynch)
- **Канонический источник:** [Канонический источник](https://x.com/BrentLynch/status/2080359232160120942)
...
#### #8: Влог о гербарии с тактильным ритмом ASMR

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Зачем нужен этот рабочий процесс

Подтверждённый источникoм UGC-бриф Seedance 2.5: от подготовки к тактильному прессованию цветов, естественному диалогу, весу книги, раскладке карточек и реалистичному виду видеокамеры.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084268630556983296/vid/avc1/1920x1080/kPWIx5WQsdO1yzGR.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084268630556983296/img/OXmdFhcGjZVL1k5f.jpg" height="420" alt="Влог о гербарии с тактильным ритмом ASMR - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2084268630556983296/vid/avc1/1920x1080/kPWIx5WQsdO1yzGR.mp4?tag=29)**
</div>

##### Доказательства

- **Автор:** [𝐌](https://x.com/Strength04_X)
- **Канонический источник:** [Канонический источник](https://x.com/Strength04_X/status/2084269139556761919)
...
### Нарративная непрерывность и игра персонажей (3)

Запишите непрерывность как ограничение - Сохраняйте личность, костюм, геометрию продукта, пространство и свет

**Избранные видеопромпты**

- [Велопрогулка в золотой час по тихим улицам](#prompt-1)

<a id="prompt-10"></a>

#### #9: Тропический дневник путешествия по Гавайям

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Зачем нужен этот рабочий процесс

Кейс с подтверждённым источником о задаче «Тропический дневник путешествия по Гавайям», с повторно используемыми инструкциями и проверяемым результатом.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084238008266493952/img/hmRCH9_UZ7aXhaeO.jpg" height="420" alt="Тропический дневник путешествия по Гавайям - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2084238008266493952/vid/avc1/1280x720/9n4ATo5xaBU_x1vP.mp4?tag=29)**
</div>

##### Доказательства

- **Автор:** [Sharon Riley](https://x.com/Just_sharon7)
- **Канонический источник:** [Канонический источник](https://x.com/Just_sharon7/status/2084238339469615320)
- **Опубликовано:** 3 августа 2026 г.
- **Язык промпта:** en
...
#### #10: UGC-влог о покупках в магазине органических продуктов

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Зачем нужен этот рабочий процесс

Основанный на источнике бриф для Seedance 2.5 в формате UGC: от селфи-съёмки к работе с продуктом, ракурсу из тележки, тактильным деталям и тёплому финалу у кассы.
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084264003682127872/vid/avc1/1280x720/1rGrJnPoav8yYZRW.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084264003682127872/img/03FN_WBFUXWCdzmT.jpg" height="420" alt="UGC-влог о покупках в магазине органических продуктов - Motion preview"></a>

*Нажмите на превью, чтобы открыть видео* · **[▶ Смотреть видео →](https://video.twimg.com/amplify_video/2084264003682127872/vid/avc1/1280x720/1rGrJnPoav8yYZRW.mp4?tag=29)**
</div>

##### Доказательства

- **Автор:** [Synthia](https://x.com/AIwithSynthia)
- **Канонический источник:** [Канонический источник](https://x.com/AIwithSynthia/status/2084264050717045019)
- **Опубликовано:** 3 августа 2026 г.
- **Язык промпта:** en
...
Нашли пример Seedance 2.5, который показывает реальный режиссёрский паттерн? Отправьте через GitHub Issues промпт, воспроизводимый результат, автора, источник, доказательство модели и режим ввода.

### GitHub issue

1. [**Отправить видеопромпт**](https://github.com/imagineVid/Awesome-seedance-2-5-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**Редакционное правило:** Сообщение о запуске не является доказательством модели. Кейс включается только тогда, когда источник прямо указывает Seedance 2.5 и содержит достаточно промпта и видео для воспроизводимого приёма.
...
**[Рост репозитории](https://star-history.com/#imagineVid/Awesome-seedance-2-5-prompts-and-skills&Date)**

---

<div align="center">

**[Создавать с Seedance 2.5](https://imaginevid.io/seedance-2-0)** •
...
<sub>Сгенерировано из версионируемых локальных данных 2026-09-14T20:12:40.560Z</sub>
